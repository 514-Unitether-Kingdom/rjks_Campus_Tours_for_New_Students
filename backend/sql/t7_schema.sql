...
CREATE TABLE IF NOT EXISTS `story_nodes` (
  ...
  `location_id`         VARCHAR(64)  NULL COMMENT '剧情地图地点 ID，见 frontend/utils/campus-map.js',
  `node_type`           ENUM('scene','map','choice') NOT NULL DEFAULT 'scene' COMMENT '剧情页类型',
  `choices_json`        JSON         NULL COMMENT '分支选项：[{text,targetNodeId,requiresMajor}]',
