...
(@campus_id,'study_profile_gate','学习区的楼很多，我按你的专业带你走，只逛跟你相关的学院楼。','学姐',@char,@bg,NULL,'choice',
 '[{"text":"按我的专业继续","requiresMajor":true,"targetNodeId":"study_library_scene","targetByCollege":{"计算机":"major_cs_scene","物联网":"major_cs_scene","信息科学技术":"major_infosci_scene","人工智能":"major_infosci_scene","机械":"major_mech_scene","智能制造":"major_mech_scene","材料":"major_material_scene","建筑工程":"major_civileng_scene","土木":"major_civileng_scene","给排水":"major_civileng_scene","智能建造":"major_civileng_scene","城市规划":"major_archurban_scene","城乡规划":"major_archurban_scene","建筑学":"major_archurban_scene","交通":"major_traffic_scene","数学":"major_mathstat_scene","力学":"major_mathstat_scene","物理":"major_physics_scene","光电":"major_physics_scene","生命科学":"major_lifesci_scene","生物":"major_lifesci_scene","环境工程":"major_environ_scene","环境科学":"major_environ_scene","经济":"major_econ_scene","管理":"major_econ_scene","金融":"major_econ_scene","会计":"major_econ_scene","法学":"major_econ_scene","社会":"major_econ_scene","外国语":"major_foreign_scene","英语":"major_foreign_scene","艺术":"major_art_scene","设计":"major_art_scene"}},{"text":"先看通用学习路线","targetNodeId":"study_library_scene"}]',0,41);
